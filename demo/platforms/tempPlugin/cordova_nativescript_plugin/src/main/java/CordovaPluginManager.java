...
import org.nativescript.cordova_nativescript_plugin.BuildConfig;
...
public class CordovaPluginManager {
	...
	public CordovaPluginManager(Map<String, String> pluginsMap) {
	...
	public void exec(String serviceName, String actionName, JSONArray actionArgs, CallbackContext callbackContext) throws Exception {
		if (!this.pluginsMap.containsKey(serviceName)) {
		...
		Class<?> c = Class.forName(this.pluginsMap.get(serviceName));
